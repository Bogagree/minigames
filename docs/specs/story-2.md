...
| -------------------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| Header на Library    | Тот же header, что Story 1; Library-ссылки открывают Library; active state. [Chrome](./library.md) | 5 · [RSS-QS-2-1-1](https://github.com/rolling-scopes-school/qualifying-stage/blob/main/tasks/minigames/tasks/story-2/RSS-QS-2-1-1-library-header-unauthenticated.md) | есть   |
| Burger на Library    | Тот же burger; active state в меню. [Chrome](./library.md)                                         | 5 · [RSS-QS-2-1-2](https://github.com/rolling-scopes-school/qualifying-stage/blob/main/tasks/minigames/tasks/story-2/RSS-QS-2-1-2-library-burger-menu.md)            | есть   |
| Footer на Library    | Тот же footer; ссылки по правилам навигации Story 2. [Chrome](./library.md)                        | 5 · [RSS-QS-2-1-3](https://github.com/rolling-scopes-school/qualifying-stage/blob/main/tasks/minigames/tasks/story-2/RSS-QS-2-1-3-library-footer.md)                 | есть   |
